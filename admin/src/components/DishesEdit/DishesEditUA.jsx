...
//       .catch((err) => {
//         console.error(err);
//         toast.error('Помилка при отриманні страв');
//       });
//   };
...
//     const errors = {};
//     if (!dish.name.trim()) errors.name = 'Назва обов’язкова';
//     if (!dish.description.trim()) errors.description = 'Опис обов’язковий';
//     if (isNaN(dish.weight) || dish.weight <= 0) errors.weight = 'Вага має бути числом більше 0';
//     if (isNaN(dish.price) || dish.price <= 0) errors.price = 'Ціна має бути числом більше 0';
//     if (!dish.category || !CATEGORIES.includes(dish.category)) errors.category = 'Оберіть коректну категорію';
//     if (isNaN(dish.priority) || dish.priority < 0) errors.priority = 'Пріоритет має бути 0 або більше';
//     return errors;
//   };
...
//       }
//     } else {
//       errors._message = error.message || 'Невідома помилка';
//     }
//     return errors;
//   };
...
//       toast.error(errors._message || 'Помилка при оновленні страви');
//     }
//   };
...
//       });
//       fetchDishes();
//       toast.success('Зображення страви успішно оновлено');
//     } catch (err) {
//       console.error('Image update error:', err);
//       toast.error('Помилка при оновленні зображення');
//     }
//   };
...
//       const errors = parseValidationErrors(err);
//       setErrors(errors);
//       toast.error(errors._message || 'Помилка при додаванні страви');
//     }
//   };
...
//     { field: 'name', headerName: 'Назва', flex: 0.8 },
//     { field: 'description', headerName: 'Опис', flex: 1.2 },
//     { field: 'weight', headerName: 'Вага', flex: 0.8, headerAlign: 'center', align: 'center' },
//     { field: 'price', headerName: 'Ціна (грн)', flex: 0.8 },
//     { field: 'category', headerName: 'Категорія', flex: 0.8 },
//     {
//       field: 'isActive',
//       headerName: 'Статус',
//       flex: 0.8,
...
//           }}
//         >
//           {params.value ? 'Активна' : 'Неактивна'}
//         </Typography>
//       ),
//     },
//     {
...
//         <h1 className="text-2xl font-bold text-indigo-300 ml-4">Редагування страв</h1>
...
//             * Вищий пріоритет показується першим у меню
//           </Typography>
//           <Typography variant="body2" sx={{ color: '#94a3b8', ml: 1 }}>
//             * Щоб оновити картинку страви натисніть на зображення в таблиці
//           </Typography>
...
//                     label={newDish.isActive ? 'Активна' : 'Неактивна'}
//                     sx={{ color: '#cbd5e1' }}
//                   />
...
//                   Не забудьте вибрати картинку для страви у форматі .png або .jpg
//                 </Typography>
...
//                     label={editingRow.isActive ? 'Активна' : 'Неактивна'}
//                     sx={{ color: '#cbd5e1' }}
//                   />
